...
def main():
    ...
    try:
        ...
        # bot.run()
        print("ADITYA-V2 Bot is starting safely...")
...
uid=4785573108,password=ADI-33FO9W0B

# OR Format 2: Line-separated
# uid: 4785573108
# password: ADI-33FO9W0B
...
def load_credentials_from_file(filename="bot.txt"):
    ...
    try:
        ...
        if not uid or not password:
            ...
            print("   uid=4802388703,password=0CDD88B49E8B9B08ECCDAC4C6AD37B6879033A234D596B8A2096F5B884AC66D4")
            print("   OR")
            print("   uid: 4802388703")
            print("   password: 0CDD88B49E8B9B08ECCDAC4C6AD37B6879033A234D596B8A2096F5B884AC66D4")
            return None, None
...
📱 Player will see:
"—͞N4YEM wants to join your team"
...
[FFDD00]━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
[00FF00][b][c]BOT MADE BY ADITYA  69x!
"""
        else:
...
def send_likes(uid):
    try:
        ...
        if res.status_code != 200:
            return f"""
[C][B][FF0000]━━━━━
[FFFFFF]LIKE API NAI TOMRA NITE CHAILE 25+LEVEL ER GUEST ID DAO!
...
[C][B][11EAFD]━━━━━━━━━━━━
[C][B][FFB300]Subscribe: [FFFFFF]@ADITYA [00FF00]!!
"""
...
[1E90FF]ＤＥＶ   [FF0000]A R A F A T C O D E X
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FF0000]_ _ _ X ³ _ _ _ _  
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[9400D3]M A D E B Y [FF0000]ADITYA  69x!
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]ADITYA_SOURCE
[FF0000]━[FFFF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
def remove_from_whitelist(uid_to_remove):
    ...
    if uid_str == "7021709939":  # Your UID
                    ...
                    try:
                        ...
                        if True:
                            ...
                            try:
                                ...
                                bot_uid = 14010319252
                                message_text = f" Can't accept Your request Talk to Aditya  codex1"
...
[b][c][FFFF00]  ⭐Wʟᴄ Aʀᴀꜰᴀᴛ Oғᴄʟ Bᴏᴛ ⭐      
                            
[b][c][FFFFFF] • Dᴀɴᴄᴇ & Eᴍᴏᴛᴇ Cᴏᴍᴍᴀɴᴅꜱ
• Tᴇᴀᴍ & Sǫᴜᴀᴅ Mᴀɴᴀɢᴇᴍᴇɴᴛ   
                            
[b][c][32CD32] 🆕Uꜱᴇ /help Tᴏ ꜱᴇᴇ Aʟʟ Cᴍᴅ..?                    
[b][c][FF8800]📞Cᴏɴᴛᴀᴄᴛ: TɪᴋTᴏᴋ :                
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FFFFFF]ꚠ[C81F9C]│[FFFF00]║[FFFFFF]@__rauniyar__aditya_[FFFF00]║
...
[b][c][FFFF00]  ⭐ Wʟᴄ ADITYA Oғᴄʟ Bᴏᴛ ⭐      
                            
[b][c][FFFFFF] • Dᴀɴᴄᴇ & Eᴍᴏᴛᴇ Cᴏᴍᴍᴀɴᴅꜱ
• Tᴇᴀᴍ & Sǫᴜᴀᴅ Mᴀɴᴀɢᴇᴍᴇɴᴛ   
                            
[b][c][32CD32] 🆕Uꜱᴇ /help Tᴏ ꜱᴇᴇ Aʟʟ Cᴍᴅ..?                    
[b][c][FF8800]📞Cᴏɴᴛᴀᴄᴛ: Telegram :-               
[B][C][FB0364]╭[D21A92]─[BC26AB]╮[FFFF00]╔═══════╗
[C][B][FF7244]│[FFFFFF]ꚠ[C81F9C]│[FFFF00]║[FFFFFF]@A__rauniyar__aditya_[FFFF00]║
[C][B][FDC92B]╰[FF7640]─[F5066B]╯[32CD32]╚═══════╝
                             """
                        # In your auto-join (Old Handler) code, find this line:
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by N4YEM OFCL 
/bio Level 70 | Pro Player
/bio Add me: N4YEM OFCL 
...
"""
                        ...
                        if inPuTMsG.strip().startswith('/wlremove'):
                            ...
                            # Check owner
                            if str(response.Data.uid) != "8725909303":
...
"""
                            ...
                            if str(response.Data.uid) != "8725909303":  # Replace with your actual UID
...
"""
                        ...
                        if inPuTMsG.strip() == '/wllist':
                            ...
                            # Check if owner
                            if str(response.Data.uid) != "8725909303":  # Your UID
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "7021709939":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {uid}"
                                    count += 1
                                    if count >= 20:
...
[FFFFFF]⚡ [00E5FF]ADITYA_SOURCE 💎
[AAAAAA]Thank you for your continued support
[00BFFF]╠════════════════════╣
[FFD700]⚡ OWNER : [FFFFFF]—͞ADITYA
[00FF99]✨ TO PURCHASE A GUILD BOT,
[00FF99]PLEASE CONTACT US ON WHATSAPP
[FFFFFF]✨ 01🤫61🤫34🤫59🤫620 💎
[00BFFF]╚════════════════════╝
[CCCCCC]✨ DEVELOPED BY </> [00E5FF]—͞ADITYA ❄️
"""
...
[FFFFFF]Example: /bundle midnight"""
                        ...
                        if inPuTMsG.strip().lower() in ("help", "/help", "hi", "hello", "Arafat"):
                            print(f"Help command detected from UID: {uid} in chat type: {XX}")
    

    
                            basic = """[b][c][1E90FF]🤖   B A S I C   C O M M A N D S   🤖
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]
...
[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3"""
...
[FF00FF]❀️ Oᴡɴᴇʀ : @ADITYA JI !!

[00FFFF]Rᴇǫᴜᴇsᴛᴇᴅ ʙʏ :
[7CFC00]━━━━━━━━━━━
[FFFFFF]Nᴀᴍᴇ : ADITYA
[00FFFF]Uɪᴅ :  7021═709939
[7CFC00]━━━━━━━━━━━
[FFC0CB] প্রিমিয়াম বট লাগলে Cᴛ Nᴏᴡ: ”IG :
...
async def MaiiiinE():
    ...
    if not credentials:
        ...
        print("📝 Format: uid=4785573108,password=ADI-33FO9W0B")
        return None
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 —͞ARAFAT BOT - INITIALIZING")
    print("=" * 50)
