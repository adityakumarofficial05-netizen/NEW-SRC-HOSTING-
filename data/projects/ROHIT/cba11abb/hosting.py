...
# --- Configuration ---
TOKEN = '8757363082:AAGOzADCwTkazsajDk6qMLtIMk3Mk-NSDF8'
OWNER_ID = 7607314151
ADMIN_ID = 7607314151
YOUR_USERNAME = '@Rohit_BhaiTOP1'
UPDATE_CHANNEL = 'https://t.me/MickeyFeedback'
...
def create_main_menu_inline(user_id):
    ...
    buttons = [
        types.InlineKeyboardButton('📢 Proofs Channel', url=UPDATE_CHANNEL),
...
def _logic_updates_channel(message):
    ...
    markup.add(types.InlineKeyboardButton('📢 Proofs Channel', url=UPDATE_CHANNEL))
...
BUTTON_TEXT_TO_LOGIC = {
    "📢 Proofs Channel": _logic_updates_channel,
