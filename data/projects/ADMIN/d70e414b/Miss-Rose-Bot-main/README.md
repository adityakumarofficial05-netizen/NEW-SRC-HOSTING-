...
class Development(Config):
    ...
    OWNER_USERNAME = "agajayofficial"  # my telegram username
    API_KEY = "37132023"  # my api key, as provided by the botfather
    SQLALCHEMY_DATABASE_URI = 'postgresql://username:password@localhost:5432/database'  # sample db credentials
    MESSAGE_DUMP = '-1003938686509' # some group chat that your bot is a member of
