...
TOKEN =('8985901508:AAHKEPNFfCgyY9FVwrh1EzqnRF4-8i9vKp4 ')
OWNER_ID = int(os.getenv('OWNER_ID', 8360629421))
ADMIN_ID = int(os.getenv('ADMIN_ID', 8360629421))
YOUR_USERNAME = os.getenv('YOUR_USERNAME', '@CUREENTTT')
UPDATE_CHANNEL = os.getenv('UPDATE_CHANNEL', 'https://t.me/os_codex')

# Limits from .env or defaults
FREE_USER_LIMIT = int(os.getenv('FREE_USER_LIMIT', 5))
SUBSCRIBED_USER_LIMIT = int(os.getenv('SUBSCRIBED_USER_LIMIT', 100))
...
# Initialize bot
bot = telebot.TeleBot("8985901508:AAHKEPNFfCgyY9FVwrh1EzqnRF4-8i9vKp4")
...
if __name__ == '__main__':
    logger.info("="*50 + "\n🤖 ADITYA Hosting Bot Starting Up...\n" + f"🐍 Python: {sys.version.split()[0]}\n" +
